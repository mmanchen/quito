...
<body class="container">
	<header>  
		<a href="index.php">
		<h1> Barcelona</h1>
		<img src="images/barcelona.jpg.png" alt="Random photo from the internet so this wouldn't be empty">
		</a>
	</header>
